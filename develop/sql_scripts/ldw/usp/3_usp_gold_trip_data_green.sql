-- we create the stored procedure to make the gold trip data table
-- the select statement is the select in 12_create_gold_trip_data
-- the rest is for the stored procedure to be rerrunable based on the years and months
-- as variables
